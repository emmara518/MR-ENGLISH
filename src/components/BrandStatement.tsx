  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-[1.05] tracking-tight mt-2">
          Better<br />
          English<br />
          <span className="text-[#C6D94E]">A Brighter</span><br />
          Future
        </h2>
      ...
      <div className="relative z-10 my-6">
        <p className="text-sm text-slate-300 font-medium leading-relaxed max-w-xs">
          Empowering your confidence through natural speaking, mastery of grammar, and dedicated mentorship.
        </p>
      </div>
      ...
      <div className="relative z-10 pt-4 border-t border-white/10">
        ...
        <div className="text-[10px] tracking-[0.25em] font-semibold text-slate-400 uppercase mt-0.5">
