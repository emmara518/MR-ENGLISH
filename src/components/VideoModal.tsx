...
export const VideoModal: React.FC<VideoModalProps> = ({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-3xl bg-[#16232E] text-white rounded-3xl overflow-hidden shadow-2xl border border-white/10">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="relative aspect-video w-full bg-slate-950 flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 bg-gradient-to-t from-[#16232E] via-transparent to-transparent">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#C6D94E] flex items-center justify-center text-[#16232E] shadow-xl transform hover:scale-110 transition-transform cursor-pointer">
              <Play className="w-7 h-7 sm:w-8 sm:h-8 fill-[#16232E] ml-1" />
            </div>
            <div className="mt-4">
              ...
              <h3 className="text-xl sm:text-2xl font-black text-white">
                Learn with Mr. Mohamed Abdelghaffar
              </h3>
              <p className="text-xs sm:text-sm text-slate-300 max-w-md mx-auto mt-1">
                "Practical English is not about memorizing lists. It is about speaking with confidence and opening doors to your future."
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 bg-[#16232E] flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-white/10">
          <div className="flex items-center space-x-4 text-xs text-slate-300">
            <span className="flex items-center">
              <CheckCircle2 className="w-3.5 h-3.5 text-[#C6D94E] mr-1.5" /> High Definition Lessons
            </span>
            <span className="flex items-center">
              <CheckCircle2 className="w-3.5 h-3.5 text-[#C6D94E] mr-1.5" /> Step-by-Step Curriculum
            </span>
          </div>
